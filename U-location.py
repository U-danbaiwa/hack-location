...
for i in range(90):
	...
	if com=="1":
		...
		time.sleep(3)
		print("")
		print(yellow+"[ * ] Victim Country_Code:<=====>",re['countryCode'])
		time.sleep(3)
		print("")
		...
		print("")
		print(yellow+"[ * ] Victim City:<=====>",re["city"])
		time.sleep(3)
		print("")
		...
		print("")
	       ...
	       os.system("ls /data/data/com.termux/files/home && rm -rf hack-location")
